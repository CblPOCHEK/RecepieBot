...
async def button_3_click(message: types.Message) :
    await bot.send_photo(message.chat.id, photo= 'https://www.patee.ru/r/x6/15/62/40/640m.jpg',caption='Вот рецепт лазаньи', reply_markup=get_keyboard_inline_2())

@dp.message_handler (lambda message: message.text == 'Вернуться к рецепту пиццы')
